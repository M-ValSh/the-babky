    ...
    <div className={css.loader_field}>
      <div className={css.scene}>
        <div className={css.cube}>
          <div className={[css.cube__face, css.cube__face__top].join(' ')}>
            {' '}
          </div>
          <div
          ...
          ></div>
          <div
            className={[css.cube__face, css.cube__face__left].join(' ')}
          ></div>
          <div
          ...
          ></div>
          <div
            className={[css.cube__face, css.cube__face__back].join(' ')}
          ></div>
        </div>
      </div>
    </div>
